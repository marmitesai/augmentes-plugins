...
Scanne le dossier `Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Life Phases/` pour trouver la phase avec le numéro le plus élevé.

Structure attendue :
```
Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Life Phases/
├── Life Phases.md
└── 1 Ma première phase/
    └── 1 Intention.md
```
...
**Crée le fichier bilan** `[N] Bilan.md` dans le dossier de la phase actuelle avec le template `Cerveaux/Cerveau Privé/4 TOOLS/Templates/Bilan Phase de vie.md`.
...
**Crée le dossier :** `Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Life Phases/[N] [Nom]/`
...
**Crée le fichier intention** `[N] Intention.md` avec le template `Cerveaux/Cerveau Privé/4 TOOLS/Templates/Phase de vie.md`.

### Étape 4 : Mettre à jour Life Phases.md

Ajoute la nouvelle phase dans le tableau de `Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Life Phases/Life Phases.md` et mets à jour la section "Phase actuelle".
...
- Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Life Phases/[N-1] .../[N-1] Bilan.md
- Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Life Phases/[N-1] .../[N-1] Intention.md (status: completed)
- Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Life Phases/[N] .../[N] Intention.md
- Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Life Phases/Life Phases.md
