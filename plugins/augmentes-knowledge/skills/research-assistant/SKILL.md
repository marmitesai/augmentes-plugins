...
1. Lis le contexte de l'utilisateur (`Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Moi.md` + intention de phase active)
2. Comprends sa casquette / son projet concerné
3. Identifie les ressources existantes pertinentes dans `Cerveaux/Cerveau Privé/3 RESSOURCES/`
...
1. `Cerveaux/Cerveau Privé/3 RESSOURCES/Recherches/` (sera créé si nécessaire)
2. Dans un projet existant : [[Projet]]
3. Autre emplacement

```

**Note :** Si le dossier `Cerveaux/Cerveau Privé/3 RESSOURCES/Recherches/` n'existe pas, le créer automatiquement.
