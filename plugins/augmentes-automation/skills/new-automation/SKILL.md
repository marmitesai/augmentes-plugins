...
1. Lis `Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Moi.md` et la phase active pour le contexte utilisateur
2. Si un process est mentionné, lis sa fiche dans `Cerveaux/Cerveau Privé/3 RESSOURCES/Process/`
...
Si c'est une nouvelle automatisation standalone, crée `Cerveaux/Cerveau Privé/3 RESSOURCES/Automatisations/Automatisation - [Nom].md` (créer le dossier `Automatisations/` s'il n'existe pas) :
