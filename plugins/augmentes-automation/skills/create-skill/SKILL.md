...
- **Skill seul** : fichier `Cerveaux/Cerveau Privé/4 TOOLS/skills/[nom]/SKILL.md`. L'IA peut l'exécuter avec /[nom]
- **Fiche seule** : `Cerveaux/Cerveau Privé/3 RESSOURCES/Process/Process - [Nom].md`. Référence humaine lisible, pas d'exécution IA
...
Crée `Cerveaux/Cerveau Privé/4 TOOLS/skills/[nom]/SKILL.md` avec ce squelette (adapté à la méthode capturée) :
...
## Références
- [[Process - Nom]] : fiche process associée dans `Cerveaux/Cerveau Privé/3 RESSOURCES/Process/`
...
Crée `Cerveaux/Cerveau Privé/3 RESSOURCES/Process/Process - [Nom].md` :
...
Si `Cerveaux/Cerveau Privé/3 RESSOURCES/Process/Cartographie des process.md` existe, ajoute le nouveau process dans la bonne section (Daily / Weekly / Monthly / Trigger / Manuel).
