...
1. Lis `Cerveaux/Cerveau Privé/2 CASQUETTES/Sur ma vie/Moi.md` pour comprendre qui est l'utilisateur
2. Vérifie si `Cerveaux/Cerveau Privé/3 RESSOURCES/Process/Cartographie des process.md` existe déjà
...
1. Crée `Cerveaux/Cerveau Privé/3 RESSOURCES/Process/Cartographie des process.md` avec la vue d'ensemble :
